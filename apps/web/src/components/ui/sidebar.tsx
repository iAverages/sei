        ...
        <Switch>
            ...
            <Match when={!isMobile()}>
                ...
                >
                    ...
                    <div
                        class={cn(
                            "w-(--sidebar-width) relative h-svh bg-transparent transition-[width] duration-150 ease-in-out",
                    ...
                    <div
                        class={cn(
                            "w-(--sidebar-width) fixed inset-y-0 z-10 hidden h-svh transition-[left,right,width] duration-150 ease-in-out md:flex",
                            local.side === "left"
...
const SidebarInset: Component<ComponentProps<"main">> = (props) => {
    ...
    return (
        <main
            class={cn(
                "relative flex w-full flex-1 flex-col bg-background overflow-auto mr-0 mb-0",
...
const SidebarGroup: Component<ComponentProps<"div">> = (props) => {
    const [local, others] = splitProps(props, ["class"]);
    return (
        <div data-sidebar="group" class={cn("relative flex w-full min-w-0 flex-col p-2", local.class)} {...others} />
    );
};
