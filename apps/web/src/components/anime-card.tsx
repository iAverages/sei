...
export const DraggableAnimeCard = (
  props: AnimeCardProps & { bringToFront: () => void },
) => {
              ...
              <ContextMenuPortal>
                <ContextMenuSubContent>
                  <ContextMenuGroup>
                    ...
                    >
                      <ContextMenuRadioItem value="WATCHING">
                        Watching
                      </ContextMenuRadioItem>
                      <ContextMenuRadioItem value="COMPLETED">
                        Completed
                      </ContextMenuRadioItem>
                      <ContextMenuRadioItem value="PLAN_TO_WATCH">
                        Plan To Watch
                      </ContextMenuRadioItem>
                      <ContextMenuRadioItem value="DROPPED">
                        Dropped
                      </ContextMenuRadioItem>
                    </ContextMenuRadioGroup>
                  </ContextMenuGroup>
